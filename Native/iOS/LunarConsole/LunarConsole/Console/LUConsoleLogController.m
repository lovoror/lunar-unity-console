...
{
    return [[[self class] alloc] initWithConsole:console];
}
...
- (void)viewDidLoad
{
    ...
    // Setting an accessiblity indentifier breaks UI tests
    // LU_SET_ACCESSIBILITY_IDENTIFIER(_tableView, @"Log Table View");
